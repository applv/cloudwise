...
insert into institution_type(name)
values ('root'),
       ('organization'),
       ('school');
...
select 'Sun ValidSchoolParentOrganization',    (select id from institution_type where name = 'school')       union all
...
where name = 'Sun ValidSchoolParentOrganization';
...
select 'a6', 'ValidSchoolParentOrganization Site',           'www.cloudcollege.com',                  (select id from institution where name = 'Cloud College') union all
select 'a7', 'ValidSchoolParentOrganization Site',           'www.sunschool.com',                     (select id from institution where name = 'Sun ValidSchoolParentOrganization')    union all
...
select 'Mary',  (select id from institution where name = 'Sun ValidSchoolParentOrganization')   union all
